...
export { SharedAccessKeySignatureProvider } from './lib/sak_signature_provider';
export { EdgedAuthConfig, IotEdgedSignatureProvider } from './lib/iotedged_signature_provider';
